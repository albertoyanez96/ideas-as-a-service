...
async function main() {
    ...
    const portfolioItems = [
        {
            ...
            tier: client_1.ServiceTier.LAUNCH_READY,
            featured: true,
        },
        {
            ...
            tier: client_1.ServiceTier.BLUEPRINT,
            featured: true,
        },
        {
            ...
            tier: client_1.ServiceTier.VALIDATION,
            featured: false,
        },
        {
            ...
            tier: client_1.ServiceTier.ENTERPRISE,
            featured: true,
        }
    ];
    ...
    const sampleIdea = await prisma.idea.create({
        data: {
            ...
            tier: client_1.ServiceTier.BLUEPRINT,
            price: 2999,
            status: client_1.IdeaStatus.IN_PROGRESS,
            userId: testUser.id,
        },
    });
        ...
        data: [
            {
                ...
                type: client_1.DeliverableType.MARKET_RESEARCH,
                status: client_1.DeliverableStatus.COMPLETED,
                ideaId: sampleIdea.id,
            },
            {
                name: 'Business Plan',
                description: 'Complete business strategy and financial projections',
                type: client_1.DeliverableType.BUSINESS_PLAN,
                status: client_1.DeliverableStatus.IN_PROGRESS,
                ideaId: sampleIdea.id,
            },
            {
                name: 'Brand Identity Package',
                description: 'Logo, color palette, and brand guidelines',
                type: client_1.DeliverableType.BRAND_IDENTITY,
                status: client_1.DeliverableStatus.PENDING,
                ideaId: sampleIdea.id,
            },
        ],
    });
